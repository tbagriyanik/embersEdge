...
export const RECIPES: Recipe[] = [
  ...
  { id: 'craft_artificial_grass', name: 'Artificial Grass', output: { ...ITEMS.artificial_grass, quantity: 5 }, ingredients: { wood: 5, berry: 10 }, levelRequired: 2, category: 'buildings' },
