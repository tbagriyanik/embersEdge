...
export const STRUCTURE_UPGRADES: Record<string, Record<number, Record<string, number>>> = {
    workbench: {
        2: { wood: 30, stone: 20 },
        3: { wood: 60, stone: 50, berry: 20 }
    },
    hut: {
        2: { wood: 40, stone: 25 },
        3: { wood: 100, stone: 80, gold_coin: 10 }
    }
};
...
export const ITEMS: { [key: string]: Item } = {
  ...
  berry_cooked: { id: 'berry_cooked', uniqueId: 'berry-cooked-base', name: 'Roasted Berries', type: 'food', icon: '🥣', description: 'Sweet and warm.', stackable: true, quantity: 0, maxStack: 99, effect: { hunger: 25, thirst: 15 } },
  ...
  berry_seed: { id: 'berry_seed', uniqueId: 'seed-base', name: 'Berry Seeds', type: 'resource', icon: '🌱', description: 'Plant in tilled soil plots.', stackable: true, quantity: 0, maxStack: 50 },
  ...
  iron_sword: { id: 'iron_sword', uniqueId: 'sword-base', name: 'Iron Sword', type: 'weapon', icon: '⚔️', description: 'Deadly blade.', stackable: false, quantity: 1, maxStack: 1, durability: 2000, maxDurability: 2000 },
  gold_coin: { id: 'gold_coin', uniqueId: 'coin-base', name: 'Gold Coin', type: 'currency', icon: '🪙', description: 'Village currency.', stackable: true, quantity: 0, maxStack: 999999999999 },
  ...
  artificial_grass: { id: 'artificial_grass', uniqueId: 'artificial-grass-base', name: 'Artificial Grass', type: 'structure', icon: '🟩', description: 'Man-made lawn.', stackable: true, quantity: 1, placeTile: 'artificial_grass' },
};
...
export const RECIPES: Recipe[] = [
  ...
  { id: 'craft_iron_sword', name: 'Iron Sword', output: { ...ITEMS.iron_sword }, ingredients: { stone: 50, wood: 20 }, levelRequired: 5, workbenchLevelRequired: 2, category: 'tools' },
  ...
  { id: 'craft_hut', name: 'Hut', output: { ...ITEMS.hut }, ingredients: { wood: 30, stone: 15 }, levelRequired: 3, workbenchLevelRequired: 1, category: 'buildings' },
  { id: 'craft_artificial_grass', name: 'Artificial Grass', output: { ...ITEMS.artificial_grass, quantity: 5 }, ingredients: { wood: 5, berry: 10 }, levelRequired: 2, workbenchLevelRequired: 3, category: 'buildings' },
  ...
  { id: 'sell_berry_single', name: 'Sell Berry (x3)', output: { ...ITEMS.gold_coin, quantity: 1 }, ingredients: { berry: 3 }, levelRequired: 1, category: 'trade' },
